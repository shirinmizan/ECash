...
namespace ECash
{
    class Customer
    {
        ...
        private string CustomerInput(string response)
        {
            ...
            {
                System.Console.WriteLine("Invalid entry please enter checking, savings, both, or (c,s,b) for your selection. What account would you like to open today?: ");
        ...
        {
            DB db = new DB();
            string sql = "INSERT INTO Customers(first_name,last_name,address1,tel) VALUES ('"+firstName+"','"+lastName+"','"+addressOne+"','"+phoneNumber+"') ";
        ...
        private string[] GetCustomerInfo(){
            string[] customerInfo = new string[] { firstName, lastName, addressOne, addressTwo, phoneNumber };
            return customerInfo;
        }
